...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GrafanaOrganizationInternal) DeepCopyInto(out *GrafanaOrganizationInternal) {
	*out = *in
	if in.JSONData != nil {
		in, out := &in.JSONData, &out.JSONData
		*out = make(json.RawMessage, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GrafanaDatasourceInternal.
func (in *GrafanaOrganizationInternal) DeepCopy() *GrafanaOrganizationInternal {
	if in == nil {
		return nil
	}
	out := new(GrafanaOrganizationInternal)
	in.DeepCopyInto(out)
	return out
}
